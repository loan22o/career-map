...
#         else:
#             st.warning("Không có dữ liệu kinh nghiệm hợp lệ để hiển thị biểu đồ.")
#     else:
#          st.warning("Cột 'EXP' không tồn tại trong dữ liệu.")
# 
# except Exception as e:
#     st.error(f"Đã xảy ra lỗi khi xử lý dữ liệu kinh nghiệm: {e}")
# 
# 
...
#         st.error(f"Lỗi: Không tìm thấy tệp dữ liệu tại đường dẫn: {file_path}. Đảm bảo thư mục 'data' và tệp 'Cleaned data.csv' tồn tại ở vị trí tương đối.")
...
#         st.error(f"Đã xảy ra lỗi khi xử lý dữ liệu kinh nghiệm: {e}")
# else:
#     st.warning("Không thể tải dữ liệu để hiển thị biểu đồ.")
# 
# 
# st.caption("Nguồn dữ liệu: TopCV, VietnamWorks – xử lý bởi nhóm CareerMap")